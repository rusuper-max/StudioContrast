...
const ITEMS = [
  ...
  // public/photos nema p6.webp — ranije je ova stranica 404-ovala i
  // prikazivala praznu stranu albuma.
  { src: "/photos/p7.webp", alt: "Foto album — fotografija 6, Studio Contrast" },
];
